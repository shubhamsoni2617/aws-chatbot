export const GetLocationForGlobe = async (transformedLocation: any, filterByCountry: any) => {
    ...
    // console.log("geo tranfrom markers for globe",transformedLocation, filterByCountry, newMarkers)
    return newMarkers;
};