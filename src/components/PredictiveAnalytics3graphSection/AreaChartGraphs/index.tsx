...
//   const isPredictiveAnalytics = false;

//   // Extract the first two keys from the data
...
const AbsenteeismCostGraphPA = (props: any) => {
    ...
    return (
      <g>
        <circle
          ...
          r={10} // outer glowl
          fill={
            dotProps?.index === 3 || dotProps?.index === 2
              ? "#c847e8"
              : "#fcb784"
          }
  ...
  const customDot2023 = (dotProps: any) => {
    ...
    return (
      <g>
        <circle cx={cx} cy={cy} r={10} fill="#a5b4ff" fillOpacity={0.3} style={{ display: val || val === 0 ? "block" : "none" }}/>
        <circle
          cx={cx}
          cy={cy}
          r={4}
