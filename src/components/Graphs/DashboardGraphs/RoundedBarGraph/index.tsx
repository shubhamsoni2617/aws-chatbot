            ...
            return (
              ...
              >
                {forPredictiveAnalytics
                  ...
                  : forYear && index === 1
                  ? "2025"
                  : payload[1]?.payload.quarter_number <=
                      getCurrentQuarterNumber() &&
                    payload[1]?.dataKey === "2024" &&
                    index === 0 &&
                    index < getCurrentQuarterNumber() - 1
                  ? "2024"
                  : entry.dataKey}
                : {entry.value}
              </p>
  ...
  return (
    <ResponsiveContainer width="100%" height={250}>
      ...
      >
        ...
        {secondYear && (
          <Bar
            key={isPredictiveAnalytics ? key3 : key2}
            dataKey={isPredictiveAnalytics ? 2025 : secondYear}
            fill={
              isPredictiveAnalytics
                ? colorPalettes[key3][0]
...
export default RoundedBarGraph;
