...
import AreaChartGraph from "../../../../components/PredictiveAnalytics3graphSection/AreaChartGraphs";
...
const RiskAlertGraphSection = (props: any) => {
  ...
  const {innerFilterLocationCountry, innerFilterLocationAddress} = useAppSelector(store => store.userData)
  ...
  return profileLoading ? (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 xl:grid-cols-6 gap-4 w-full">
      <CardWrapper
        classes="flex flex-col col-span-1 sm:col-span-4 lg:col-span-4 xl:col-span-4 h-[450px]"
        compareModalDateReciever={compareModalDateReciever}
        heading={`World Map ${
          (innerFilterLocationCountry !=='All' ?innerFilterLocationCountry : "") ? "/" + innerFilterLocationCountry : ""
        } ${
