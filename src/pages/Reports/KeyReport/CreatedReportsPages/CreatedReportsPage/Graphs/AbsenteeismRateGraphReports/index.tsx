...
const AbsenteeismRateGraphReports = ({
  data,
  ...
  const availableKeys = Object.keys(data[0]).filter(
    (key) => key !== xAxisKey && key !== "quarter" && key!=='api_quarter' && key!=='quarter_number'
  );
...
//                   ? "2025"
//                   : ((payload[1]?.payload.quarter_number <= getCurrentQuarterNumber() &&
//                   payload[1]?.dataKey === "2024" ) && index === 0 && index < getCurrentQuarterNumber()-1)? "2024":entry.dataKey}
//                 : {entry.value}
//               </p>
//             );
//           })}
...
export default AbsenteeismRateGraphReports;
